...
export default function Login({ onLogin }) {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      if (email === 'corporate@redlinegearcleaning.com' && password === 'ENTER') {
        onLogin({ email, name: 'Redline Corporate', role: 'ROLE_FRANCHISE' });
      } else {
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex flex-1 bg-[#1a2a4a] items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center z-10 px-12">
          ...
          <p className="text-white/40 text-sm mt-2">Corporate — Staging Environment</p>
        </div>
      </div>
    </div>
  );
